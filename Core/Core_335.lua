...
local function applyLabels()
    ...
    setText(QuestInfoDescriptionHeader, "Описание")
    setText(QuestInfoRequiredMoneyText, "Необходимо денег:")
    ...
    applyFont(QuestInfoDescriptionHeader, 13)
    applyFont(QuestInfoRequiredMoneyText, 13)
end
